...
<div id="wrap">
	<form id="frm_join" action="${conPath }/join.do" method="POST" enctype="multipart/form-data" >
	<table id="join">
		<tr>
			<td colspan="2">
				<h2>Register - 회원 가입</h2>
			</td>
		</tr>
		<tr>
			<td>아이디 *</td>
		...
		<tr>
			<td>이메일 *</td>
			<td><input type="email" id="mEmail" name="mEmail" required="required" /></td>
		</tr>
		<tr>
			<td>회원사진</td>
		...
		<tr>
			<td>연락처 *</td>
			<td><input type="text" id="mTel" name="mTel" required="required" /></td>
		</tr>
		<tr>
			<td>성별 *</td>
			<td>
		...
		<tr>
			<td>주소 *</td>
			<td><input type="text" id="mAddr" name="mAddr" required="required" /></td>
		</tr>
		<tr>
			<td>회원소개</td>
			<td>
				<textarea name="mText" rows="12" cols="40"></textarea>
			</td>
		</tr>
		<tr>
			<td>생년월일 *</td>
			<td>
				...
				<input type="hidden" id="mBirth" name="mBirth" />
			</td>
		</tr>
		<tr>
			<td colspan="2">
