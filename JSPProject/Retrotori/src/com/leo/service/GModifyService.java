...
public class GModifyService implements Service {
	...
	public void excute(HttpServletRequest request, HttpServletResponse response) {
		...
		int modifyResult = gDao.modifyGame(gDto);
		
		if (modifyResult == GameDao.SUCCESS) {
			System.out.println("게임수정 성공 : service");
			request.setAttribute("modifyGameResult", "게임수정 성공했습니다 : " + gDto.getgName());
		} else {
