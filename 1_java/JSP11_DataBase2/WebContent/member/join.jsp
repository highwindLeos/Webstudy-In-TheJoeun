	...
	<form action="joinOk.jsp" method="POST">
		<table>
			...
			<tr>
				...
				</select> - <input type="text" id="phone2" name="phone2" size="4" /> - <input
					type="text" id="phone3" name="phone3" size="4" /></td>
			</tr>
			<tr>
				<td>성별</td>
				<td>
			...
			<tr>
				<td colspan="2">
					...
					<input type="reset" value="취소하기" /> <input type="button" value="로그인" onclick="location.href = 'login.jsp'" />
				</td>
			</tr>
		</table>
	</form>
