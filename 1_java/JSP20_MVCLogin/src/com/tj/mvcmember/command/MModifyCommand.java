...
public class MModifyCommand implements Command {
	...
	public void excute(HttpServletRequest request, HttpServletResponse response) {
		...
		int maxSize = 1024*1024*5; //최대사이즈 5M
		String mPhoto = "";
		...
		try {
				...
				String copyFolder = "C:/Users/Leodays/Desktop/Dev/webstudy/1_java/JSP20_MVCLogin/WebContent/memberPhoto/" + mPhoto;
		...
		if(modifyResult == MemberDao.SUCCESS) {
			...
			session.setAttribute("sessionMdto", dto);
			request.setAttribute("modifyMsg","수정이 완료되었습니다");
			
		} else if(modifyResult == MemberDao.FAIL) {
			request.setAttribute("modifyMsg","수정 실패 하였습니다.");
		}
